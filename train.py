...
def data_config(parser):
    ...
    parser.add_argument("--init_checkpoint", default='mt_dnn_models/bert_model_base_chinese.pt', type=str)
    parser.add_argument("--init_config", default='mt_dnn_models/bert_config.json',type=str)
    parser.add_argument('--data_dir', default='data/canonical_data/bert_uncased_lower')
    parser.add_argument('--data_sort_on', action='store_true')
    parser.add_argument('--name', default='farmer')
    #parser.add_argument('--task_def', type=str, default="experiments/glue/glue_task_def.yml")
    parser.add_argument('--task_def', type=str, default="experiments/glue/glue_simq_def.yml")
    parser.add_argument('--train_datasets', default='qqp')
    parser.add_argument('--test_datasets', default='qqp')
...
#print("args.train_datasets={}".format(args.train_datasets))
...
set_environment(args.seed, False)

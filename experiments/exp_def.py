...
class TaskDef(dict):
    def __init__(self, label_vocab, n_class, data_type, task_type, metric_meta, split_names, enable_san, dropout_p, loss, kd_loss, adv_loss, name):
        """
...
class TaskDefs:
    def __init__(self, task_def_path):
        ...
        for task, task_def in self._task_def_dic.items():
            ...
            print("data_format={}".format(task_def["data_format"]))

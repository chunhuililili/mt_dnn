...
class SANBertNetwork(nn.Module):
    def __init__(self, opt, bert_config=None, initial_from_local=False):
        ...
        #print("EncoderModelType._value2member_map_={}".format(EncoderModelType._value2member_map_))
        ...
        if not initial_from_local:
            ...
            print("####load from {}".format(opt['init_checkpoint']))
            ...
            print("####load from {}".format(self.preloaded_config))
    ...
    def encode(self, input_ids, token_type_ids, attention_mask, inputs_embeds=None):
        ...
        #print("[chunhui][matcher] outputs={}".format(outputs.last_hidden_state))

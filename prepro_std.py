...
from data_utils import load_data, load_clue_data, load_qianyan_data
...
#@dataclass
#class Options:
#    model: str = "bert-base-uncased"  # support all BERT and ROBERTA family supported by HuggingFace Transformers
#    do_lower_case: bool = False
#    do_padding: bool = False
#    root_dir: str = "data/canonical_data"
#    task_def: str = "experiments/glue/glue_task_def.yml"
#    task_type: str = "glue"  # glue/clue/qianyan MTDNN默认是GLUE，CLUE的文件组织是{task}/{split}.json，qianyan同MTDNN


def parse_args():
    parser = argparse.ArgumentParser('Preprocessing GLUE/SNLI/SciTail dataset.')
    ...
    parser.add_argument('--task_type', type=str, default="clue")
